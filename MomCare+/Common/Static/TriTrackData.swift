...
enum TriTrackData {
    static let trimesterData: [TrimesterData] = [
        ...
        .init(
            ...
            babyWeightInGrams: 0.00,
            babyTipText: """
            Fertilization has occurred! The single-celled zygote begins rapidly dividing and becomes a blastocyst as it journeys through the fallopian tube toward the uterus. By the end of the week, implantation into the uterine wall begins. This is when the pregnancy truly begins and the placenta starts to form.
            """,
            momTipText: """
            Although you won't notice any outward symptoms, incredible changes are underway. Your body produces more progesterone to maintain the uterine lining. Some women may experience light spotting (implantation bleeding), fatigue, or heightened senses. Your hCG hormone level is starting to rise, though still too low for a home pregnancy test to detect.
            """
        ),
        .init(
            weekNumber: 4,
            ...
            babyTipText: """
            The blastocyst has implanted in the uterine wall and is now called an embryo. It is forming two layers: the epiblast and the hypoblast, which will eventually give rise to the baby and supporting tissues. The amniotic sac and yolk sac begin to form, providing protection and nourishment. The embryo is about the size of a poppy seed.
            """,
            momTipText: """
            You might begin to suspect you're pregnant. Some early signs include mild cramping, breast tenderness, mood swings, or nausea. A missed period is the most noticeable sign. The hormone hCG (human chorionic gonadotropin) is now being produced in detectable amounts, confirming pregnancy on a test. Your body is working overtime to create a safe environment for your developing baby.
            """
        ),
        .init(
            weekNumber: 5,
            ...
            babyTipText: """
            At this stage, your baby is still very small, about the size of a sesame seed. The embryo now consists of three layers: the ectoderm (which will form the nervous system, skin, and hair), the mesoderm (which will form muscles, bones, and the circulatory system), and the endoderm (which will form organs like the liver and lungs). The neural tube, which will develop into the brain and spinal cord, is starting to form. A tiny heart is beginning to beat, though it's not yet detectable by a standard ultrasound.
            """,
            momTipText: """
            You may experience early pregnancy symptoms like morning sickness, fatigue, frequent urination, and mood swings due to hormonal shifts. Your body is working hard to nurture the growing embryo. You may also notice that your breasts are tender, and your sense of smell could be heightened. Although the baby is still tiny, the changes in your body are already noticeable, and your body is preparing for the next few stages of pregnancy.
            """
        ),
        .init(
            weekNumber: 6,
            ...
            babyTipText: """
            Your baby is about the size of a lentil and continues to grow rapidly. By now, the heart has begun to form and is beating, though the beats may not yet be heard on an ultrasound. The facial features, like the eyes and nostrils, are starting to take shape. Small buds that will eventually develop into arms and legs are forming. The brain and spinal cord are becoming more advanced as the embryo's organs continue to develop.
            """,
            momTipText: """
            This week is when many women start experiencing the typical pregnancy symptoms, such as morning sickness, fatigue, and increased urination. You may also feel more emotional or have heightened senses. Your body is undergoing dramatic hormonal changes to support the pregnancy, and you may notice that you're more sensitive to certain smells or tastes. It's important to stay hydrated and get adequate rest as your body adjusts to this early stage.
            """
        ),
        .init(
            weekNumber: 7,
        ...
        .init(
            ...
            babyWeightInGrams: 1,
            babyTipText: """
            Your baby is now about the size of a raspberry. All the major organs and systems are in place and continuing to develop. The arms and legs are more distinguishable, and the fingers and toes are beginning to form. Tiny veins can be seen underneath the translucent skin. The baby's mouth, nose, and ears are developing, and the brain is growing rapidly, becoming more complex. Though the baby is still small, it's starting to move, but the movements are too tiny to feel.
            """,
            momTipText: """
            At this stage, you might begin to show a slight baby bump as your uterus grows and expands. Hormonal changes are continuing to affect your body, leading to physical changes like increased blood flow, which can cause a "pregnancy glow." The symptoms of pregnancy, such as morning sickness, fatigue, and breast tenderness, are likely still present. You may also experience heightened emotions due to the dramatic hormonal fluctuations. It's essential to continue focusing on self-care, as your body requires extra energy during this time.
            """
        ),
        .init(
            weekNumber: 9,
        ...
        .init(
            ...
            babyWeightInGrams: 4,
            babyTipText: """
            At this stage, your baby is about the size of a date. The body is now growing faster than the head, and the neck is starting to develop, elongating the head. The baby's arms and legs are becoming more defined, and the fingers and toes are fully separated. The digestive system is beginning to function, and the kidneys are producing urine. The baby's skin is still very thin and translucent, and the facial features are becoming more distinct. Hair follicles and nails are starting to form, and the baby's movements are becoming more coordinated.
            """,
            momTipText: """
            You may still experience morning sickness, although it could start to subside soon for some women. As your pregnancy progresses, your body's blood volume is increasing, which might make you feel more tired or short of breath. Your uterus is continuing to grow, and you may begin to notice changes in your body shape. Emotional swings are common, and you might feel more sensitive or overwhelmed at times. It's essential to take care of your emotional and physical well-being, ensuring you're getting enough rest and nutrition to support the baby's development.
            """
        ),
        .init(
            weekNumber: 11,
        ...
        .init(
            ...
            babyTipText: """
            At this point, your baby is the size of a peach. The baby is developing more muscle and bone tissue, and while the baby still has a lot of growing to do, it's starting to look more human. The baby's vocal cords are developing, and the intestines are moving into the abdominal cavity, where they will soon start to function more effectively. You may notice that the baby is starting to develop tiny, fine hair called lanugo, which covers the entire body for protection and warmth.
            """,
            momTipText: """
            You may notice that your energy levels are up, and your morning sickness continues to fade. Your uterus has grown enough that you might be able to feel it just above your pubic bone. This week, your clothes may be starting to fit more snugly around the waist. The increased blood flow and hormones can cause changes to your skin, including the appearance of darkened areas, particularly around your areolas. Your breasts may still be tender, but the soreness is likely to lessen. This is also a great time to continue with regular prenatal care visits to ensure that both you and the baby are progressing well.
            """
        ),
        .init(
            weekNumber: 15,
            ...
            babyTipText: """
            Your baby is now about the size of a pear. The baby's bones are becoming more defined and harder, and muscle development is progressing rapidly. The baby is able to make more coordinated movements, although you won't feel them yet. The skin is translucent and thin, but it's starting to develop a layer of fat underneath, which will help keep the baby warm in the coming weeks. The baby is now able to move its arms and legs, and the brain is growing rapidly, allowing for more complex movements in the future.
            """,
            momTipText: """
            By week 15, many women feel better physically and mentally as the risks of miscarriage decrease and the baby's growth stabilizes. The fatigue and nausea you may have been experiencing should start to lessen, and you may feel more like yourself. Your body is continuing to change as your uterus grows and your baby develops. You may experience some round ligament pain as your body adjusts to the growing uterus. Your appetite may increase, and you may start craving specific foods. The second trimester is often marked by a sense of relief and increased comfort.
            """
        ),
        .init(
            weekNumber: 16,
            ...
            """,
            momTipText: """
            Your belly is likely becoming more pronounced as your uterus grows. You may experience changes in your body, such as skin pigmentation, including a dark line running down the center of your abdomen (linea nigra). Your energy levels should be higher now, and morning sickness may be a thing of the past. You may also feel more movement from your baby, especially if you're already a second-time mom. Some women also experience increased appetite and are beginning to gain weight more steadily. Continue focusing on your physical and emotional well-being as the second trimester progresses.
            """
        ),
        .init(
            weekNumber: 17,
            ...
            babyTipText: """
            At 17 weeks, your baby is about the size of an orange. The baby is becoming more active, and you might start feeling the first signs of movement, especially if this isn't your first pregnancy. The baby's muscles and bones are becoming stronger, and the baby's skeleton is hardening. The skin is still very thin and translucent, but it's beginning to develop a layer of fat beneath it. The baby's digestive system is continuing to mature, and the kidneys are functioning properly. Your baby is now able to hear sounds, and you might notice that the baby responds to louder noises.
            """,
            momTipText: """
            At 17 weeks, you may start feeling the first signs of baby movement. The baby's muscles and bones are becoming stronger, and the skeleton is hardening. Your body is continuing to adjust to the pregnancy, and you may notice changes in your appetite and energy levels. Some women experience round ligament pain or mild cramping as the uterus continues to expand. This is a good time to start thinking about maternity clothes if you haven't already, as your belly continues to grow.
            """
        ),
        .init(
            weekNumber: 18,
        ...
        .init(
            ...
            babyTipText: """
            At 20 weeks, your baby is about the size of a banana. This is the halfway point of your pregnancy! The baby's movements are becoming more noticeable, and you might feel more kicks and rolls. The baby's hair, eyebrows, and eyelashes are beginning to grow, and the skin is becoming less transparent. The baby's bones are continuing to harden, and the circulatory system is fully functioning. The baby is now able to suck its thumb and practice swallowing, and it's even developing a sense of taste as it swallows amniotic fluid. The baby's brain is growing rapidly, and its nervous system is continuing to mature.
            """,
            momTipText: """
            By week 20, you are officially halfway through your pregnancy, and your belly is growing larger every day. You may notice a more distinct baby bump, and you might be able to feel the baby's movements regularly. Your energy levels may be higher compared to the first trimester, and many women report feeling a surge of enthusiasm. Your breasts might still be tender, and you might experience some swelling as your blood volume increases. Your skin is continuing to change, with some women noticing the "pregnancy glow." It's also a good time to start thinking about the logistics of your delivery and take childbirth or prenatal classes if you haven't already.
            """
        ),
        .init(
            weekNumber: 21,
        ...
        .init(
            ...
            babyTipText: """
            At 26 weeks, your baby is about the size of a lettuce, measuring nearly 14 inches and weighing about 2 pounds. The baby's eyes, which have been fused shut, are now beginning to open, revealing the iris beneath. Although vision is limited in the womb, light and shadows can be detected. Brain wave activity is increasing, and the baby can now respond to touch and sound with more intention. Nerve pathways in the ears are developing, allowing the baby to hear internal sounds like your heartbeat, digestive noises, and external sounds like voices or music. The baby practices breathing by inhaling amniotic fluid, and its nostrils are starting to open.
            """,
            momTipText: """
            By week 26, you're nearing the end of your second trimester. You may be experiencing more pronounced symptoms like swelling in your ankles, feet, or hands, especially at the end of the day. Blood volume continues to increase, sometimes causing visible veins on your legs or breasts. Stretch marks might appear as your skin stretches to accommodate your growing uterus. You might also notice more frequent leg cramps or difficulty getting comfortable while sleeping. Your appetite may increase, so continue focusing on nutrient-dense foods. Emotionally, you may feel more connected to your baby as movements become stronger and more consistent.
            """
        ),
        .init(
            weekNumber: 27,
        ...
        .init(
            ...
            babyTipText: """
            At 32 weeks, your baby is about the size of a jicama or small pumpkin, weighing close to 3.8 to 4 pounds and measuring about 16.5 to 17 inches long. The baby is getting stronger and more coordinated with movements — you may feel frequent jabs, rolls, and stretches. The skin is now more opaque and smoother thanks to the fat accumulating underneath. Hair continues to grow on the scalp, and fingernails may reach the tips of the fingers. The digestive system is nearly complete, and the baby is practicing swallowing and breathing to prepare for life outside. If born now, the baby would likely do very well with medical support.
            """,
            momTipText: """
            At this point, you may feel increasingly heavy and uncomfortable. Your uterus has expanded to more than 5 inches above your belly button and is pressing on your lungs and stomach, leading to shortness of breath and heartburn. Fatigue is common, but bursts of energy related to nesting may still occur. You may be experiencing mood swings, anxiety about labor, or feelings of impatience as the due date nears. Swelling in your extremities can worsen, especially if standing for long periods. Some women develop varicose veins or hemorrhoids during this time. It's also a good time to create a birth plan and take a hospital tour if possible.
            """
        ),
        .init(
            weekNumber: 33,
            ...
            babyTipText: """
            Your baby is now about the size of a pomelo, weighing close to 4.2 to 4.5 pounds and measuring around 17 to 17.5 inches long. Inside the womb, your baby is continuing to plump up, gaining nearly half a pound per week as fat stores accumulate under the skin. The bones are fully developed, although still soft and flexible to prepare for the journey through the birth canal. The skull remains pliable for the same reason. At this point, the baby's immune system is getting stronger, with antibodies being transferred from your body through the placenta. The lungs and brain continue maturing.
            """,
            momTipText: """
            As you move deeper into the third trimester, your body is carrying significant weight. Your uterus has risen well above your belly button, making your center of gravity shift more forward. This can cause backaches, pelvic discomfort, and even occasional numbness or tingling in your limbs due to pressure on nerves. Sleep may be elusive as you try to find a comfortable position, and you may also experience heartburn, constipation, and swelling in your feet or ankles. Some women develop carpal tunnel syndrome due to fluid retention. Emotionally, it's a mix of excitement and apprehension as the due date nears.
            """
        ),
        .init(
            weekNumber: 34,
            ...
            babyTipText: """
            At 34 weeks, your baby weighs approximately 4.7 to 5 pounds and measures about 17.5 to 18 inches long — around the size of a butternut squash. The fat layers beneath the skin are thickening, helping the baby maintain warmth after birth. The central nervous system and lungs are in their final stages of development, and while most babies born at this stage can survive outside the womb, they may still require some medical support. The baby can now blink, close the eyes during sleep, and open them when awake. Your little one is practicing vital skills like sucking, breathing, and swallowing.
            """,
            momTipText: """
            By week 34, many moms-to-be feel increasingly tired and physically stretched. The growing belly can cause discomfort in the back and pelvis, and many women begin to waddle due to the loosening of pelvic joints in preparation for labor. Swelling in the hands, feet, and face may be more noticeable — be sure to consult your provider if it's sudden or severe. Sleep may be more challenging than ever, and shortness of breath, frequent urination, and leg cramps may continue. You might also experience colostrum leaking from your breasts. Make sure your hospital bag is ready, and review your birth plan with your doctor or midwife.
            """
        ),
        .init(
            weekNumber: 35,
            ...
            babyTipText: """
            Your baby now weighs about 5.3 to 5.5 pounds and measures roughly 18 to 18.5 inches long — comparable to a pineapple. At this stage, the baby's development is largely focused on fine-tuning the organs and gaining weight. The skin is becoming less red and wrinkled and more smooth and pink due to increased fat. The brain is growing rapidly, and the baby is storing calcium and iron from the mother. The kidneys are fully developed, and the liver can now process some waste products. The lungs are nearly mature, and surfactant production continues. The baby continues practicing movements like sucking and breathing.
            """,
            momTipText: """
            You might feel like you're nearing the finish line — but the final few weeks can feel physically taxing. Your uterus is now crowding your other organs, making heartburn, indigestion, and frequent urination even more pronounced. You may notice a slowing of weight gain, although your baby is still growing quickly. Braxton Hicks contractions may occur more often and can feel stronger — but they should still be irregular and non-painful. Vaginal discharge may increase, and you may even notice your mucus plug starting to loosen. Some women experience increased fatigue, while others get a surge of energy known as the "nesting boost."
            """
        ),
        .init(
            weekNumber: 36,
            ...
            babyTipText: """
            At 36 weeks, your baby is about the size of a honeydew or small watermelon, weighing around 5.8 to 6 pounds and measuring about 18.5 to 19 inches in length. The baby is considered late preterm this week, but by the end of this week, many care providers consider the baby full-term. The lungs are usually developed enough to support breathing outside the womb. Most body systems — including the immune and digestive systems — are fully functional or very close. The baby continues to shed vernix and lanugo, swallowing both, which will become part of the baby's first bowel movement (meconium).
            """,
            momTipText: """
            This week marks the beginning of your ninth month, and your body is likely feeling more ready for birth than ever. You may notice that your bump has shifted lower, relieving pressure on your diaphragm but increasing it on your bladder — resulting in more frequent urination. You may feel increased pelvic pressure or even shooting pains down your legs if the baby presses on a nerve. Walking, climbing stairs, and sleeping may all become more difficult. Your care provider might begin weekly internal exams to check for signs of dilation or effacement.
            """
        ),
        .init(
            weekNumber: 37,
            ...
            babyTipText: """
            Your baby is now considered early term, meaning most major organs are mature enough to function independently outside the womb. Your little one weighs about 6.2 to 6.5 pounds and measures about 19 to 19.5 inches long — about the size of a small jackfruit. The baby's body continues building fat stores, especially around the arms and legs, making the skin look fuller and less wrinkled. The lungs are producing surfactant to help with breathing after birth, and the brain is still developing rapidly. By now, the head may have dropped into your pelvis, and most babies are positioned head-down in preparation for delivery.
            """,
            momTipText: """
            At week 37, you're officially in the home stretch. Your body is preparing in many visible and invisible ways. You might feel increased pelvic pressure or heaviness as the baby settles lower, making walking and moving around more difficult. Many women experience frequent urination, back pain, difficulty sleeping, and even occasional bursts of energy. You might lose your mucus plug, and Braxton Hicks contractions may become more frequent or intense. Your cervix may begin to dilate and efface, and your healthcare provider might start performing weekly internal exams. Make sure your hospital bag is ready.
            """
        ),
        .init(
            weekNumber: 38,
            ...
            babyTipText: """
            Your baby is now about the size of a Swiss chard, weighing 6.8 to 7 pounds and measuring around 19.5 to 20 inches. At this point, all of the baby's organs, including the lungs, are ready for life outside the womb. The baby continues to gain weight steadily, about half an ounce per day, and is perfecting coordination for life outside, such as sucking, grasping, and responding to sounds. Vernix continues to shed, and the baby is swallowing amniotic fluid, which becomes part of the first poop — meconium. The baby's skin is now smooth, the body rounded, and the head may already be engaged in your pelvis.
            """,
            momTipText: """
            You may feel like you're on high alert now, watching for every cramp or twinge and wondering if it's the start of labor. Your belly is stretched to its maximum size, and simple tasks like standing up, bending over, or sleeping comfortably may feel nearly impossible. You may experience increased pelvic pressure, lightning crotch (sharp pelvic zings), more frequent Braxton Hicks contractions, and an increase in vaginal discharge. You could even have some bloody show, a sign your cervix is preparing for labor. You might feel antsy, tired, or very emotional. Try to stay calm, walk often, rest when you can.
            """
        ),
        .init(
            weekNumber: 39,
            ...
            babyTipText: """
            Your baby is considered full term, weighing around 7.2 to 7.6 pounds and measuring 20 to 20.5 inches long — about the size of a mini pumpkin. The brain continues growing at a fast pace, gaining about 30% in mass during the last four weeks, and this development will continue well into infancy. The baby's skin is no longer translucent, and fat continues to develop, especially around the cheeks and limbs, giving your baby that adorable chubby appearance. The umbilical cord is about 20 inches long and half an inch thick. At this stage, the placenta is providing antibodies that will help protect your baby's immune system after birth.
            """,
            momTipText: """
            Your body is in final preparation mode, and it can feel like an emotional roller coaster. You might feel ready one moment and nervous the next. Many women feel intense pelvic pressure, lower back pain, or frequent contractions that may start to form patterns — a sign labor could be near. You might experience diarrhea, increased discharge, or an uptick in nesting energy. Your cervix could already be dilated, effaced, or still closed — and all of these are normal. If you're feeling exhausted, give yourself permission to rest. If you're restless, keep up gentle movement. You are almost there.
            """
        ),
        .init(
            weekNumber: 40,
            ...
            babyTipText: """
            You've reached the official due date, though many babies arrive a little before or after. Your baby weighs about 7.5 to 8 pounds and is around 20.5 to 21 inches long — about the size of a small pumpkin. Most of the lanugo is gone, and only a small amount of vernix may remain. Your baby's organs are fully developed, and the lungs are secreting surfactant to help with the transition to breathing air. The fingernails and toenails may now reach the fingertips. The skull bones are still soft and not yet fused to allow for flexibility during birth. Don't worry if labor hasn't started yet — only about 5% of babies are born on their actual due date.
            """,
            momTipText: """
    ...
    static func getTrimesterData(for week: Int) -> TrimesterData? {
        trimesterData.first { $0.weekNumber == week }
    }
}
