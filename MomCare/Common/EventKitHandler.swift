...
actor EventKitHandler {
    ...
    private func getEventInfo(from event: EKEvent) -> EventInfo {
        ...
        return EventInfo(
            ...
            eventIdentifier: event.eventIdentifier, calendarItemIdentifier: event.calendarItemIdentifier, calendarItemExternalIdentifier: event.calendarItemExternalIdentifier, title: event.title, location: event.location, notes: event.notes, url: event.url, startDate: event.startDate, endDate: event.endDate, isAllDay: event.isAllDay, calendarTitle: event.calendar.title, timeZone: event.timeZone, availability: event.availability
    ...
    private func getReminderInfo(from reminder: EKReminder) -> ReminderInfo {
        ...
        return ReminderInfo(
            ...
            reminderIdentifier: reminder.calendarItemIdentifier, calendarItemIdentifier: reminder.calendarItemIdentifier, calendarItemExternalIdentifier: reminder.calendarItemExternalIdentifier, title: reminder.title, notes: reminder.notes, dueDateComponents: reminder.dueDateComponents, isCompleted: reminder.isCompleted, calendarTitle: reminder.calendar.title, timeZone: reminder.timeZone
