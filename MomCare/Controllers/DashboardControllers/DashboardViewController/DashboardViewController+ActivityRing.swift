...
extension DashboardViewController {
    ...
    func addHKActivityRing(to cellView: UIView, withSummary summary: HKActivitySummary? = nil) {
        ...
        let ringColors: [UIColor] = [
            ...
            UIColor(hex: "DF433D"), UIColor(hex: "30D130"), UIColor(hex: "DA6239")
    ...
    private func extractMaxValues() async -> [Double] {
        ...
        return [
            ...
            Utils.getStepGoal(week: MomCareUser.shared.user?.pregancyData?.week ?? 1), await Utils.getWorkoutGoal(), MomCareUser.shared.user?.plan.totalCalories ?? 1
