...
class PlaylistTableViewController: UITableViewController {
    ...
    func setupMusicPlayer(with song: Song) {
        ...
        let barButtons: [UIBarButtonItem] = [
            ...
            createBarButtonItem(systemName: "play.fill", action: #selector(playPauseButtonTapped)), createBarButtonItem(systemName: "forward.fill", action: #selector(forwardButtonTapped)), createBarButtonItem(systemName: "x.circle.fill", action: #selector(crossButtonTapped))
