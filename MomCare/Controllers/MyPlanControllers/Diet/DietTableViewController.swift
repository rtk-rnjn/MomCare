...
class DietTableViewController: UITableViewController {
    ...
    private func headerCell(for indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.updateElements(
            ...
            with: mealNames[indexPath.section], segueHandler: performSegueToSearch, allConsumed: allConsumed
        ...
        return UIContextMenuConfiguration(identifier: nil, previewProvider: previewProvider) { _ in
            ...
            let deleteAction = UIAction(title: "Delete", image: UIImage(systemName: "trash"), attributes: .destructive) { _ in
                ...
                let actionHandlers = [
                    ...
                    AlertActionHandler(title: "Cancel", style: .cancel, handler: nil), AlertActionHandler(title: "Delete", style: .destructive) { _ in
