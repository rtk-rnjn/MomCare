...
class BreathingAnimationManager {
    ...
    @MainActor func setupAnimatedGradientBackground(in view: UIView) {
        ...
        gradientLayer.colors = [
            ...
            color1.cgColor, color2.cgColor, color3.cgColor, color4.cgColor, color5.cgColor
    ...
    private let petalColors: [UIColor] = [
        ...
        UIColor(hex: "#bfaee0"), UIColor(hex: "#f7d6e0"), UIColor(hex: "#e6d6f7"), UIColor(hex: "#f7d6ec"), UIColor(hex: "#ffd6d6"), UIColor(hex: "#e3c6f7")
    ...
    private func animateGradientColors() {
        ...
        let toColors: [CGColor] = [
            ...
            UIColor(hex: "#2a1a4d").cgColor, UIColor(hex: "#4b3577").cgColor, UIColor(hex: "#8c6fc9").cgColor, UIColor(hex: "#e3c6f7").cgColor, UIColor(hex: "#f7d6e0").cgColor
    ...
    private func createCircleLayer(index: Int) -> CAShapeLayer {
        ...
        let circlePath = UIBezierPath(
            ...
            arcCenter: CGPoint(x: circleSize/2, y: circleSize/2), radius: circleSize/2, startAngle: 0, endAngle: 2 * .pi, clockwise: true
