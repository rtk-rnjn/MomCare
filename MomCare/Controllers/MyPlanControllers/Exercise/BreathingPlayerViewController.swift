...
class BreathingPlayerViewController: UIViewController {
    ...
    func updateGradientBackground() {
        ...
        gradientLayer.colors = [
            ...
            upperColor.withAlphaComponent(1.0).cgColor, middleColor.withAlphaComponent(1.0).cgColor, bottomColor.withAlphaComponent(1.0).cgColor
    ...
    private func setupAssuringMessageLabel() {
        ...
        NSLayoutConstraint.activate([
            ...
            assuringMessageLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor), assuringMessageLabel.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: 120)
    ...
    private func setupInstructionLabel() {
        ...
        NSLayoutConstraint.activate([
            ...
            instructionLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor), instructionLabel.topAnchor.constraint(equalTo: view.topAnchor, constant: 120)
    ...
    private func setupTimerLabel() {
        ...
        NSLayoutConstraint.activate([
            ...
            timerLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor), timerLabel.topAnchor.constraint(equalTo: instructionLabel.bottomAnchor, constant: 20)
    ...
    private func setupControlButtons() {
        ...
        NSLayoutConstraint.activate([
            ...
            stackView.centerXAnchor.constraint(equalTo: view.centerXAnchor), stackView.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -50), stackView.widthAnchor.constraint(equalToConstant: 300), stackView.heightAnchor.constraint(equalToConstant: 60)
