...
class SignUpExtendedTableViewController: UITableViewController {
    ...
    @IBAction func intoleranceButtonTapped(_ sender: UIButton) {
        ...
        presentMedicalDetailSelector(
            ...
            sender: sender, options: Intolerance.allCases.map { $0.rawValue }, assignTo: { self.intolerances = $0 }
    ...
    @IBAction func preExistingConditionTapped(_ sender: UIButton) {
        ...
        presentMedicalDetailSelector(
            ...
            sender: sender, options: PreExistingCondition.allCases.map { $0.rawValue }, assignTo: { self.preExistingConditions = $0 }
    ...
    @IBAction func dietaryPreferenceTapped(_ sender: UIButton) {
        ...
        presentMedicalDetailSelector(
            ...
            sender: sender, options: DietaryPreference.allCases.map { $0.rawValue }, assignTo: { self.dietaryPreferences = $0 }
    ...
    private func presentMedicalDetailSelector(
        ...
        sender: UIButton, options: [String], assignTo: @escaping ([String]) -> Void
