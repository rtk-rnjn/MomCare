...
class SignUpTableViewController: UITableViewController, UITextFieldDelegate {
    ...
    @IBAction func createButtonTapped(_ sender: UIButton) {
        ...
        let requiredFields: [(UITextField, String, String)] = [
            ...
            (firstNameField, "First Name Required", "Please enter your first name."), (emailField, "Email Required", "Please enter your email."), (passwordField, "Password Required", "Please enter your password."), (confirmPasswordField, "Confirm Password Required", "Please confirm your password."), (mobileNumberField, "Mobile Number Required", "Please enter your mobile number.")
        ...
        let user = User(
            ...
            firstName: firstNameField.text!, lastName: lastNameField.text, emailAddress: emailField.text!, password: passwordField.text!, countryCode: "91", phoneNumber: mobileNumberField.text!
