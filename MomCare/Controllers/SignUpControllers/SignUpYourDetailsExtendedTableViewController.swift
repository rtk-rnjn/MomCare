...
class SignUpYourDetailsExtendedTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        private func configureExistingConditionPopUpButton() {
            let options = [
                "None", "Diabetes (Type 1, Type 2, Gestational)",
                "Hypertension", "Polycystic Ovary Syndrome (PCOS)",
                "Anemia", "Asthma", "Heart Disease", "Kidney Disease"
            ]
        ...
        private func configureFoodIntolerancePopUpButton() {
            let options = [
                "None", "Lactose Intolerance", "Gluten Sensitivity",
                "Egg Allergy", "Seafood Allergy", "Soy Allergy",
                "Dairy Allergy", "Wheat Allergy", "Others"
            ]
        ...
        private func configureDietaryPreferencePopUpButton() {
            let options = [
                "None", "Vegetarian", "Non-Vegetarian", "Vegan",
                "Pescatarian", "Flexitarian", "Gluten-Free",
                "Low-Carb / Ketogenic", "High-Protein",
