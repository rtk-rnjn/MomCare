...
class AddEventTableViewController: UITableViewController {
    ...
    static let repeatTimeOptions: [String: TimeInterval] = [
        ...
        "Never": -1, "Every Day": 24 * 60 * 60, "Every Week": 24 * 60 * 60 * 7, "Every 2 Week": 24 * 60 * 60 * 7 * 2, "Every Month": 24 * 60 * 60 * 7 * 30, "Every Year": 24 * 60 * 60 * 7 * 30 * 12

    ]

    static let travelTimeOptions: [String: TimeInterval] = [

        "None": -1, "5 Minutes": 5 * 60, "10 Minutes": 10 * 60, "15 Minutes": 15 * 60, "30 Minutes": 30 * 60, "1 Hour": 60 * 60, "1 Hour, 30 Minutes": 90 * 60, "2 Hours": 120 * 60

    ]

    static let alertTimeOptions: [String: TimeInterval] = [

        "None": -1, "At time of event": 0, "5 Minutes before": 5 * 60, "10 Minutes before": 10 * 60, "15 Minutes before": 15 * 60, "30 Minutes before": 30 * 60, "1 Hour before": 60 * 60, "2 Hours before": 120 * 60, "1 Day before": 24 * 60 * 60, "2 Day before": 24 * 60 * 60 * 2, "1 Week before": 24 * 60 * 60 * 7
