...
//  MomCare
//
//  Created by Khushi Rana on 27/08/25.
//
...
enum AppContent {
    enum AboutUs {
        ...
        static let quote = "Every pregnancy has its own story, its own rhythm, its own needs. Our mission is to provide the personal, unwavering support that honors yours."
    }
}
