...
enum PregnancySymptoms {
    static let allSymptoms: [Symptom] = [
        Symptom(
            name: "Back Pain",
            description: "Common due to hormonal changes that loosen joints, the shift in your center of gravity, and extra weight gain. The pain is often felt in the lower back.",
        ...
        Symptom(
            name: "Bleeding Gums",
            description: "Hormonal changes can make your gums more susceptible to plaque, leading to inflammation and bleeding. This is often called 'pregnancy gingivitis'.",
        ...
        Symptom(
            name: "Cramps",
            description: "Mild cramping is often caused by the stretching of your uterus or 'round ligament pain' as it supports your growing belly. It often feels like a pulling sensation.",
        ...
        Symptom(
            name: "Dizziness",
            description: "Your circulatory system expands rapidly during pregnancy, which can lead to lower blood pressure and feelings of lightheadedness. Low blood sugar can also be a cause.",
        ...
        Symptom(
            name: "Feeling Hot",
            description: "An increased metabolic rate and a higher volume of blood circulating in your body can make you feel warmer than usual.",
        ...
        Symptom(
            ...
            description: "Rapidly changing hormones are thought to be the main cause of strong cravings for certain foods and sudden aversions to others you used to enjoy.",
        ...
        Symptom(
            name: "Headaches",
            description: "Hormonal shifts, especially in the first trimester, are a common cause. Dehydration, stress, and lack of sleep can also trigger them.",
        ...
        Symptom(
            name: "Incontinence",
            description: "The growing uterus puts pressure on your bladder, which can cause leakage of urine when you cough, sneeze, laugh, or exercise (stress incontinence).",
        ...
        Symptom(
            ...
            description: "Your breasts may start to leak a yellowish, thick fluid called colostrum. This is your body's way of preparing to produce breast milk.",
        ...
        Symptom(
            name: "Peeing a Lot",
            description: "Your body produces more blood, and your kidneys work harder to filter it, creating more urine. Later in pregnancy, your baby's head presses on your bladder.",
        ...
        Symptom(
            name: "Pelvic Pain",
            description: "Often called Symphysis Pubis Dysfunction (SPD) or Pelvic Girdle Pain (PGP). Hormones soften the ligaments that stabilize your pelvis, causing pain and instability.",
        ...
        Symptom(
            ...
            description: "These are swollen veins in the rectum, often caused by increased pressure from the uterus and constipation-related straining.",
        ...
        Symptom(
            name: "Skin Changes",
            description: "Hormones can cause a dark line to appear on your belly (linea nigra), dark patches on your face (melasma or 'mask of pregnancy'), and stretch marks.",
            ...
            whenToCallDoctor: "If you develop a new rash or severe itching, especially on your hands and feet (a sign of cholestasis)."
        ),
        Symptom(
            name: "Stomach Pain",
            description: "Mild stomach pain can be due to gas, constipation, or the stretching of round ligaments. It is usually temporary and not severe.",
        ...
        Symptom(
            ...
            description: "Your body retains more fluid during pregnancy (edema), and the pressure from your uterus can slow blood return from your legs.",
        ...
        Symptom(
            ...
            description: "One of the earliest signs of pregnancy. Hormonal changes increase blood flow and cause changes in breast tissue to prepare for breastfeeding.",
        ...
        Symptom(
            ...
            description: "Extreme fatigue is very common, especially in the first and third trimesters. Your body is working hard to grow the placenta and the baby.",
        ...
        Symptom(
            ...
            description: "Hormonal changes can alter the pH balance of the vagina, making it easier for yeast to grow.",
        ...
        Symptom(
            ...
            description: "Bleeding during pregnancy requires immediate medical attention to rule out serious conditions. It can range from light spotting to heavy bleeding.",
        ...
        Symptom(
            ...
            description: "An increase in a thin, milky-white discharge (leukorrhea) is normal during pregnancy due to increased estrogen production.",
        ...
        Symptom(
            name: "Varicose Veins",
            description: "The weight of the growing uterus puts pressure on the large vein on the right side of your body (the inferior vena cava), increasing pressure in the leg veins.",
        ...
        Symptom(
            ...
            description: "Nausea and vomiting are very common, especially in the first trimester, likely caused by rapidly rising hormone levels.",
