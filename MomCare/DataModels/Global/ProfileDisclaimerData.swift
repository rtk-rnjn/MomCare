...
enum DisclaimerData {
    ...
    public static let allDisclaimers: [DisclaimerItem] = [
        ...
        DisclaimerItem(
            ...
            icon: "stethoscope", title: "1. General Medical Disclaimer", content: """
            ...
            icon: "lightbulb", title: "2. Daily Tips", content: "DISCLAIMER: The daily tips provided on the dashboard are intended as general guidance and for informational purposes. While we strive to provide accurate and useful information, we make no representation or warranty of any kind regarding the accuracy, validity, or completeness of these tips.", source: nil

        ), DisclaimerItem(

            icon: "fork.knife", title: "3. Personalized Meal Plans", content: """
            ...
            icon: "figure.walk", title: "4. Exercise & Yoga Plans", content: """
            ...
            icon: "chart.line.uptrend.xyaxis", title: "5. Baby Growth and Development Tracker", content: """
            ...
            icon: "book", title: "6. Pregnancy Articles", content: """
            ...
            icon: "face.smiling", title: "7. Mood Tracking and Music Suggestions", content: """
...
enum TermsData {
    ...
    static let allSections: [LegalSectionItem] = [
        ...
        LegalSectionItem(type: .standard(
            ...
            icon: "checkmark.seal.fill", title: "Acceptance of Terms", content: "By downloading, installing, accessing, or using the MomCare mobile application and related services, you acknowledge that you have read, understood, and agreed to be bound by these Terms of Service and our Privacy Policy.\n\nIf you do not agree with these Terms, or any future updates to them, you must not access or use the App. Your continued use of the App after any changes or updates to these Terms constitutes your acceptance of those changes."

        )), LegalSectionItem(type: .eligibility), LegalSectionItem(type: .overview), LegalSectionItem(type: .standard(

            icon: "exclamationmark.triangle.fill", title: "Disclaimers and Emergency Guidance", content: "All content and features are for informational purposes only and are not a substitute for professional medical advice. In case of any medical emergency, immediately call your doctor or go to the nearest hospital. Use of the MomCare app is at your own discretion and risk."

        )), LegalSectionItem(type: .standard(

            icon: "person.fill.checkmark", title: "User Responsibilities", content: "You agree not to use the app in any unlawful manner, tamper with its functionalities, or submit misleading health data."

        )), LegalSectionItem(type: .standard(

            icon: "c.circle.fill", title: "License and Intellectual Property", content: "MomCare and all associated content, features, and branding are the exclusive intellectual property of MomCare and are protected by law. You are granted a limited, non-exclusive license for personal, non-commercial use only. You may not copy, modify, distribute, or reverse engineer any part of the app."

        )), LegalSectionItem(type: .standard(

            icon: "lock.shield.fill", title: "Data Consent & Privacy", content: "By using our Services, you grant MomCare the right to collect, store, and process your data in accordance with our Privacy Policy. We use anonymized and aggregated data to improve our services and will never sell your personal data."

        )), LegalSectionItem(type: .thirdParty), LegalSectionItem(type: .standard(

            icon: "creditcard.fill", title: "Subscriptions", content: "Some advanced features may require a subscription. Payments are processed via the App Store, and you can manage or cancel your subscription in your account settings."

        )), LegalSectionItem(type: .standard(

            icon: "hand.raised.fill", title: "Limitation of Liability", content: "MomCare provides the app “as-is” without warranties. We are not liable for indirect damages from your use of the app and do not guarantee it will be error-free."

        )), LegalSectionItem(type: .standard(

            icon: "building.columns.fill", title: "Governing Law", content: "These terms are governed by the laws of India. Any disputes shall be resolved in the courts of Gautam Budh Nagar."

        )), LegalSectionItem(type: .standard(

            icon: "envelope.fill", title: "Contact Us", content: "For questions or feedback, please contact us at:\n**Email:** support@ourdomain\n**Website:** "
...
enum GDPRData {
    ...
    static let allRights: [GDPRRightItem] = [
        ...
        GDPRRightItem(
            ...
            iconName: "person.text.rectangle.fill", title: "The Right to Access", description: "You have the right to request a copy of the personal data we hold about you."

        ), GDPRRightItem(

            iconName: "pencil.circle.fill", title: "The Right to Rectification", description: "If you believe any of the data we hold about you is inaccurate or incomplete, you have the right to have it corrected."

        ), GDPRRightItem(

            iconName: "trash.fill", title: "The Right to Erasure", description: "You can request that we delete your personal data from our systems. This is also known as the 'Right to be Forgotten'."

        ), GDPRRightItem(

            iconName: "pause.circle.fill", title: "The Right to Restrict Processing", description: "You have the right to request that we temporarily or permanently stop processing all or some of your personal data."

        ), GDPRRightItem(

            iconName: "arrow.down.doc.fill", title: "The Right to Data Portability", description: "You can request a copy of your personal data in a common, machine-readable format to transfer to another service."

        ), GDPRRightItem(

            iconName: "speaker.slash.fill", title: "The Right to Object", description: "You have the right to object to us processing your personal data for specific purposes, such as direct marketing."
...
enum CreditsData {
    ...
    static let teamMembers: [TeamMember] = [
        ...
        .init(imageName: nil, name: "Aryan Singh", role: "Team Lead, UI/UX & Ideation"), .init(imageName: nil, name: "Khushi Rana", role: "Frontend & Research"), .init(imageName: nil, name: "Nupur Sharma", role: "Frontend & Research"), .init(imageName: nil, name: "Ritik Ranjan", role: "Frontend/Backend Developer")

    ]

    static let mentors: [Credit] = [

        .init(name: "Vinod Kumar", description: "For his dedicated guidance."), .init(name: "Valuable Feedback From", description: "Kiran Singh, Probeer Shaw, Runumi Devi and Shruti Sachdeva.")

    ]

    static let specialThanks: [Credit] = [

        .init(name: "Amit Gulati · Apple", description: "For expert insights."), .init(name: "Prasad BS · Infosys", description: "For feedback on UI and business aspects.")
...
enum LicenseData {
    ...
    static let appLicense: [LicenseInfo] = [
        ...
        .init(
            ...
            name: "MomCare+", license: "GNU General Public License v2.0", urlString: "https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html"
    ...
    static let projectReport: [LicenseInfo] = [
        ...
        .init(
            ...
            name: "MomCare+ Project Report", license: "View project documentation", urlString: "https://github.com/rtk-rnjn/MomCare"
    ...
    static let thirdPartyLicenses: [LicenseInfo] = [
        ...
        .init(
            ...
            name: "LNPopupController", license: "MIT License", urlString: "https://github.com/LeoNatan/LNPopupController"

        ), .init(

            name: "FSCalendar", license: "MIT License", urlString: "https://github.com/WenchaoD/FSCalendar"

        ), .init(

            name: "Realm Swift", license: "Apache License 2.0", urlString: "https://github.com/realm/realm-swift"
