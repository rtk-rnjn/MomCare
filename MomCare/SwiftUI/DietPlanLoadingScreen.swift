...
struct DietPlanLoadingScreen: View {
    ...
    let messages = [
        ...
        "Analyzing your nutritional needs...", "Creating personalized meal options...", "Optimizing for maternal health...", "Finalizing your perfect meal plan...", "Almost ready..."
