        ...
        ZStack {
            ...
            .background(
                ...
                LinearGradient(
                    ...
                    colors: [Color(hex: "E5D4D3"), Color(hex: "E5D4D3")], startPoint: .top, endPoint: .bottom
            ...
            if isShowingInfo, let exercise = showingExerciseInfo {
                ...
                exerciseInfoCard(for: exercise)
                    ...
                    .transition(.asymmetric(
                        ...
                        insertion: AnyTransition.scale(scale: 0.3).combined(with: AnyTransition.opacity).combined(with: AnyTransition.move(edge: .bottom)), removal: AnyTransition.scale(scale: 0.8).combined(with: AnyTransition.opacity).combined(with: AnyTransition.move(edge: .top))
            ...
            if showingCalendar {
                ...
                progressCalendarView
                    ...
                    .transition(.asymmetric(
                        ...
                        insertion: AnyTransition.scale.combined(with: AnyTransition.opacity), removal: AnyTransition.scale.combined(with: AnyTransition.opacity)
                ...
                RoundedRectangle(cornerRadius: 4)
                    ...
                    .frame(
                        ...
                        width: min(
                            ...
                            geometry.size.width * CGFloat(viewModel.totalCompletedExercises) / CGFloat(2 + viewModel.exercises.count), geometry.size.width
                ...
                RoundedRectangle(cornerRadius: 4)
                    ...
                    .frame(
                        ...
                        width: targetSteps > 0 ?
                            ...
                            min(geometry.size.width * CGFloat(currentSteps) / CGFloat(targetSteps), geometry.size.width) : 0, height: 6
            ...
            ZStack {
                ...
                Circle()
                    ...
                    .stroke(
                        ...
                        Color(hex: "924350"), style: StrokeStyle(lineWidth: 4, lineCap: .round)
            ...
            RoundedRectangle(cornerRadius: 16)
                ...
                .fill(
                    ...
                    LinearGradient(
                        ...
                        colors: [Color(hex: "FBE8E5")], startPoint: .topLeading, endPoint: .bottomTrailing
        ...
        .background(
            ...
            RoundedRectangle(cornerRadius: 18)
                ...
                .shadow(
                    ...
                    color: Color.black.opacity(isShowingInfo ? 0.15 : 0), radius: isShowingInfo ? 12 : 0, x: 0, y: isShowingInfo ? 6 : 0
    ...
    private func exerciseBenefits(for exercise: Exercise) -> some View {
        ...
        VStack(alignment: .leading, spacing: 10) {
            ...
            LazyVGrid(
                ...
                columns: [GridItem(.flexible(), spacing: 6), GridItem(.flexible(), spacing: 6)], spacing: 6
                    ...
                    benefitTag(text: tag)
                        ...
                        .animation(
                            ...
                            .spring(response: 0.9, dampingFraction: 0.7)
                                ...
                                .delay(0.9 + Double(index) * 0.1), value: isShowingInfo
    ...
    private func loadWeeklyProgress() {
        ...
        for i in 0..<7 {
            ...
            progress.append(DayProgress(
                ...
                day: day, dayName: dayName, completionPercentage: mockProgressValues[i]
