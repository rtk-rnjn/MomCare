    ...
    private var infoCardsView: some View {
        ...
        HStack(spacing: 12) {
            ...
            CompactInfoCard(
                ...
                title: "Baby This Week", iconName: "👶", previewText: getTruncatedText(from: babyInfo, maxLength: 100), isEmoji: true, backgroundColor: Color(hex: "FBE8E5"), accentColor: Color(hex: "924350")
            ...
            .onTapGesture {
                ...
                let popupContent = PopupInfoCard(
                    ...
                    title: "Baby This Week", content: babyInfo, isShowing: $showingBabyInfo, cardPosition: selectedCardPosition, accentColor: Color(hex: "924350")
            ...
            CompactInfoCard(
                ...
                title: "Mom This Week", iconName: "🤰", previewText: getTruncatedText(from: momInfo, maxLength: 100), isEmoji: true, backgroundColor: Color(hex: "FBE8E5"), accentColor: Color(hex: "924350")
            ...
            .onTapGesture {
                ...
                let popupContent = PopupInfoCard(
                    ...
                    title: "Mom This Week", content: momInfo, // Pass the full content

                    isShowing: $showingMomInfo, cardPosition: selectedCardPosition, accentColor: Color(hex: "924350")
                ...
                if let fruitImage {
                    ...
                    Image(uiImage: fruitImage)
                        ...
                        .rotation3DEffect(
                            ...
                            .degrees(wiggleAmount ? 5 : -5), axis: (x: 0, y: 1, z: 0)
                        ...
                        .animation(
                            ...
                            Animation.easeInOut(duration: 1.5)
                                ...
                                .repeatForever(autoreverses: true), value: wiggleAmount
            ...
            Image(systemName: "arrow.right")
                ...
                .animation(
                    ...
                    Animation.easeInOut(duration: 0.6)
                        ...
                        .repeatCount(3, autoreverses: true), value: isShowingAnimation
                        ...
                        Image(uiImage: babyImage)
                            ...
                            .animation(
                                ...
                                Animation.easeInOut(duration: 1)
                                    ...
                                    .repeatCount(2, autoreverses: true), value: isShowingAnimation
        ...
        GeometryReader { geometry in
            ...
            Path { path in
                ...
                addPreciseCornerStitches(
                    ...
                    to: &path, center: CGPoint(x: width - cornerRadius, y: cornerRadius), radius: effectiveRadius, startAngle: -.pi/2, endAngle: 0, stitchCount: cornerStitchCount
                ...
                addPreciseCornerStitches(
                    ...
                    to: &path, center: CGPoint(x: width - cornerRadius, y: height - cornerRadius), radius: effectiveRadius, startAngle: 0, endAngle: .pi/2, stitchCount: cornerStitchCount
                ...
                addPreciseCornerStitches(
                    ...
                    to: &path, center: CGPoint(x: cornerRadius, y: height - cornerRadius), radius: effectiveRadius, startAngle: .pi/2, endAngle: .pi, stitchCount: cornerStitchCount
                ...
                addPreciseCornerStitches(
                    ...
                    to: &path, center: CGPoint(x: cornerRadius, y: cornerRadius), radius: effectiveRadius, startAngle: .pi, endAngle: 3 * .pi/2, stitchCount: cornerStitchCount
    ...
    private func addPreciseCornerStitches(to path: inout Path, center: CGPoint, radius: CGFloat, startAngle: CGFloat, endAngle: CGFloat, stitchCount: Int) { // swiftlint:disable:this function_parameter_count
        ...
        for i in 0..<stitchCount {
            ...
            let startPoint = CGPoint(
                ...
                x: center.x + radius * cos(startAnglePoint), y: center.y + radius * sin(startAnglePoint)

            )

            let endPoint = CGPoint(

                x: center.x + radius * cos(endAnglePoint), y: center.y + radius * sin(endAnglePoint)
                    ...
                    VStack(spacing: 16) {
                        ...
                        HStack(spacing: 12) {
                            ...
                            CompactInfoCard(
                                ...
                                title: "Baby Development", iconName: "👶", previewText: "At this point, your baby is the size of a peach. The baby is developing more defined facial features and unique fingerprints...", isEmoji: true, backgroundColor: Color(hex: "FBE8E5"), accentColor: Color(hex: "924350")

                            )

                            CompactInfoCard(

                                title: "Mom This Week", iconName: "🤰", previewText: "Your pregnancy is starting to show! Morning sickness should be easing up as the second trimester begins...", isEmoji: true, backgroundColor: Color(hex: "FBE8E5"), accentColor: Color(hex: "924350")
